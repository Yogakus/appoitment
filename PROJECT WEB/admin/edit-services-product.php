...
if(isset($_POST['submit']))
 ...
 $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "update  tblserviceproduct set ServiceName='$sername',Cost='$cost' where ID='$eid' ");
    if ($query) {
...
<body class="cbp-spmenu-push">
  ...
  <?php
 $cid=$_GET['editid'];
$ret=mysqli_query($con,"select * from  tblserviceproduct where ID='$cid'");
$cnt=1;
