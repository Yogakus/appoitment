...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tblserviceproduct(ServiceName,Cost) value('$sername','$cost')");
    if ($query) {
    	echo "<script>alert('Service has been added.');</script>"; 
    		echo "<script>window.location.href = 'add-services-product.php'</script>";   
    $msg="";
  }
  else
    {
